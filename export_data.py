...
# edit by fuzongfei
# 使用方法
# python test4.py -uzhangsan -p123.com -H172.17.10.40 -P3306 -dtest -D./ -egbk -txlsx -f aaa.sql
# python test4.py -uzhangsan -p123.com -H172.17.10.40 -P3306 -dtest -D./ -eutf-8 -ttxt -f aaa.sql
